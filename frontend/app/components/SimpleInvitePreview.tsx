  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <>
        ...
        >
        {/* Header */}
        <div className="p-6 text-center text-white bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 backdrop-blur-sm">
          <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl flex items-center justify-center backdrop-blur-sm">
        ...
        <div className="p-6 space-y-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50">
          ...
          {/* Event Details */}
          <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 p-4 rounded-lg backdrop-blur-sm shadow-lg">
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-10 h-10 bg-blue-500/20 border border-blue-400/30 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                  <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </div>
                <div className="text-white">
                  <strong className="text-blue-300 text-lg">Thời gian:</strong>
                  <div className="text-white/90 mt-1">{formattedDate} lúc {formattedTime}</div>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="w-10 h-10 bg-red-500/20 border border-red-400/30 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                ...
                <div className="text-white">
                  <strong className="text-blue-300 text-lg">Địa điểm:</strong>
          ...
          {demoData.event.program_outline.length > 0 && (
            <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 p-4 rounded-lg backdrop-blur-sm">
              <h3 className="text-lg font-semibold mb-4 text-white flex items-center">
                <div className="w-8 h-8 bg-cyan-500/20 border border-cyan-400/30 rounded-lg flex items-center justify-center mr-3">
              ...
              <div className="space-y-3">
                {demoData.event.program_outline.map((item, index) => (
                  <div key={index} className="flex items-center py-3 px-4 bg-slate-800/50 rounded-lg border border-white/10 backdrop-blur-sm">
                    <div 
                      className="w-16 text-sm font-bold text-cyan-400 bg-cyan-500/20 border border-cyan-400/30 px-2 py-1 rounded-lg text-center"
                    >
                      {item.time}
                    </div>
          ...
          {/* RSVP Section */}
          <div className="text-center space-y-6 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 p-6 rounded-lg backdrop-blur-sm">
            <p className="text-white text-lg">
              <strong className="text-blue-300">Vui lòng phản hồi trước {demoData.rsvp.deadline}</strong>
            </p>
            <div className="flex gap-4 justify-center">
              <button 
                className="group relative px-8 py-4 rounded-xl text-white font-bold bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 hover:from-blue-500/30 hover:to-cyan-500/30 hover:border-blue-400/50 transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20"
          ...
          {/* QR Code Section */}
          <div className="text-center bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 p-6 rounded-lg backdrop-blur-sm shadow-lg">
        ...
        {/* Footer */}
        <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border-t border-blue-500/30 p-4 text-center text-sm text-white/70 backdrop-blur-sm">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-lg bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 hover:from-blue-500/30 hover:to-cyan-500/30 hover:border-blue-400/50 text-white transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/20"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
          </svg>
