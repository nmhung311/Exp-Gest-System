        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-300 text-xl leading-relaxed">
              Create your account to access AI, Blockchain, and Digital Solutions for your enterprise.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/3 bg-slate-800 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Enter your information to create your account</p>
          </div>
