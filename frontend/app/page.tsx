...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Header */}
      <header className="relative z-50 px-6 py-4 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8">
            <div className="text-left max-w-none">
              ...
              <h1 className="text-6xl font-bold text-white mb-8 leading-tight whitespace-nowrap" style={{fontSize: '60px'}}>
              ...
              <p className="text-xl text-gray-300 mb-12 max-w-3xl leading-relaxed whitespace-nowrap">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
            <Link 
              href="/" 
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 border border-white/20"
            >
              Explore Solutions
            </Link>
            <Link 
              href="/" 
              className="text-white hover:text-blue-300 font-medium py-4 px-8 transition-colors duration-300"
            >
              About Us
            </Link>
          </div>
          ...
          <div className="mt-20">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Core Business Areas</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* AI Card */}
              <div className="group relative bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:bg-slate-800/70 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
              ...
              <div className="group relative bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:bg-slate-800/70 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-blue-500 rounded-xl mb-6 flex items-center justify-center">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-20 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Global Support</h3>
              <p className="text-gray-400 mb-6">
      ...
      {/* Footer */}
      <footer className="relative bg-slate-900/50 backdrop-blur-sm border-t border-slate-700/50 py-12 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <span className="text-lg font-bold text-white">EXP TECHNOLOGY</span>
                  <p className="text-xs text-gray-400">Co., Ltd</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-400 hover:text-white transition-colors">AI Solutions</Link></li>
                <li><Link href="/" className="text-gray-400 hover:text-white transition-colors">Blockchain</Link></li>
                <li><Link href="/" className="text-gray-400 hover:text-white transition-colors">E-commerce</Link></li>
